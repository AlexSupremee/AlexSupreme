...
#text = """
#< [ Telegram Alex_Modz ] > X < [ telegram Lilbotgaming] >"""[1:]
...
from alexsupreme import AlexSupreme

__CHANNEL_USERNAME__ = "AlexSupremeChannel"
__GROUP_USERNAME__   = "AlexSupremeDiscussion"
...
def load_client_details():
    ...
    data = response.json()
    print(Colorate.Horizontal(Colors.red_to_yellow, '=============[ LOCATION ]============='))
...
if __name__ == "__main__":
    ...
    while True:
        ...
        cpm = AlexSupreme(acc_access_key)
        ...
        while True:
            ...
            if service == 0: # Exit
                ...
                if status == 0:
                    print(Colorate.Horizontal(Colors.red_to_yellow, 'SUCCESSFUL'))
                    print(Colorate.Horizontal(Colors.red_to_yellow, '======================================'))
                    print(Colorate.Horizontal(Colors.red_to_yellow, f'INFO: In order to tweak this account with CPMElsedev.'))
